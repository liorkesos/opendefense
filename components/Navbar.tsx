...
const Navbar: React.FC = () => {
  ...
  const links = [
    { name: 'אודות', href: isHomePage ? '#about' : '/#about' },
    { name: 'תוכנית הכנס', href: '/schedule', isExternal: false },
    { name: 'סיכום 2025', href: isHomePage ? '#recap' : '/#recap' },
    { name: 'צור קשר', href: isHomePage ? '#contact' : '/#contact' }
  ];

...
const scheduleData = [
  ...
  { time: '09:20', title: 'פיתוח AI מתקדם בסביבה נתיקה , MCP , Bigdata , LLM', description: 'אמיר זייד, רפאל', icon: Shield, type: 'tech' },
  { time: '09:40', title: 'הנגשת AI ו-MLOPS - ממר״ם', description: 'אריאל פולק - מנהל מוצר AI הענן המבצעי , דין פלבן מנכ"ל dagshub', icon: Cpu, type: 'tech' },
  { time: '10:00', title: 'Building Developer Ecosystems in Mobility', description: 'גל עוז-ארי, קלע מערכות', icon: Navigation, type: 'tech' },
  { time: '10:20', title: 'שימוש בקוד פתוח כדי לייצר מועמדים למערכת הביטחון; הזדמנות ל-RISC-V', description: 'אל״מ (מיל), פרופ׳ עודד מרגלית - מדען ראשי next silicon', icon: Code, type: 'tech' },
  ...
  { time: '13:25', title: 'ענן Modelyo למערכות מסווגות, מקרה בוחן של Nets', description: 'אל"מ י׳ רמ"ח אלומות, וד"ר יצחק אביב Modelyo', icon: Cpu, type: 'tech' },
  { time: '13:45', title: 'לגלוש על צונאמי עם נושאת מטוסים', description: 'ארז שרון ,ארכיטקט AI , אלתא', icon: Plane, type: 'tech' },
  { time: '14:05', title: 'ארוחת צהריים', description: '', icon: Coffee, type: 'break' },
];

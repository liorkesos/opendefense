...
const scheduleData = [
  ...
  { time: '09:20', title: 'פיתוח AI מתקדם בסביבה נתיקה', description: 'LLM , Bigdata , MCP | נציג רפאל, רפאל', icon: Shield, type: 'tech' },
  { time: '09:40', title: 'הנגשת AI ו-MLOPS - ממר״ם', description: 'אריאל פולק (מנהל מוצר AI הענן המבצעי), דין פלסן (מנכ"ל Dagshub)', icon: Cpu, type: 'tech' },
  { time: '10:00', title: 'Building Developer Ecosystems in Mobility', description: 'גל עוז-ארי, קלע מערכות', icon: Navigation, type: 'tech' },
  { time: '10:20', title: 'שימוש בקוד פתוח למערכת הביטחון', description: 'הזדמנות ל-RISC-V | אל״מ (מיל), פרופ׳ עודד מרגלית - מדען ראשי Next Silicon', icon: Code, type: 'tech' },
  { time: '10:40', title: 'הפסקה', description: '', icon: Coffee, type: 'break' },
  ...
  { time: '12:00', title: 'פאנל AI ביטחוני', description: '', icon: Users, type: 'keynote' },
  { time: '12:30', title: 'ארוחת צהריים', description: '', icon: Coffee, type: 'break' },
  { time: '13:30', title: 'ה-AAIF: קוד פתוח בעולם ה-AI', description: 'עמי שלזינגר', icon: Radio, type: 'keynote' },
  { time: '13:50', title: 'מו״פ ביטורנט טאקטי', description: 'גיא מנור (ראש צוות GetApp, אלביט) / שי סעדה (לינווייט)', icon: Shield, type: 'tech' },
  { time: '14:10', title: 'ענן Modelyo למערכות מסווגות', description: 'מקרה בוחן של Nets | אל"מ י׳ רמ"ח אלומות, וד"ר יצחק אביב Modelyo', icon: Cpu, type: 'tech' },
  { time: '14:30', title: 'פאנל תעשיות ביטחוניות', description: '', icon: Users, type: 'keynote' },
  { time: '15:00', title: 'לגלוש על צונאמי עם נושאת מטוסים', description: 'ארז שרון, ארכיטקט AI, אלתא', icon: Plane, type: 'tech' },
  { time: '15:20', title: 'סיום הכנס', description: '', icon: Clock, type: 'general' },
];

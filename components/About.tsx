      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="lg:text-center max-w-3xl mx-auto mb-16 reveal">
          ...
          <p className="mt-4 max-w-2xl text-xl text-slate-400 lg:mx-auto">
            OpenDefense הוא כנס מקצועי המתקיים אחת לשנה ומציע הזדמנות ייחודית לחבר בין מומחי קוד פתוח, מובילי חדשנות בבינה מלאכותית, מהנדסים, קציני צה״ל בכירים ובכירי התעשיות הביטחוניות.
          </p>
        </div>
